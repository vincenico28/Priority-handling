  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-bold cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-signal text-surface-dark font-extrabold shadow hover:-translate-y-0.5 hover:bg-signal/90",
        heroGhost:
          "border border-surface-dark-foreground/35 text-surface-dark-foreground font-semibold hover:bg-surface-dark-foreground/10",
        inverse:
          "bg-primary-foreground text-primary font-bold shadow hover:bg-primary-foreground/90",
      },
      size: {
